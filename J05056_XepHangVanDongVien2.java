...
class Athlete {
    ...
    public Athlete(String id, String name, String birth, String in, String out) {
        this.id = id;
        this.hoTen = name;
        this.ngaySinh = birth;
...
public class J05056_XepHangVanDongVien2 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            a.add(new Athlete(id, sc.nextLine(), sc.nextLine(), sc.nextLine(), sc.nextLine()));
        }
        for (Athlete vdv : a) {
        ...
        Collections.sort(a, new Comparator<Athlete>() {
            @Override
            public int compare(Athlete t, Athlete t1) {
                return t.getTimeRank() >= t1.getTimeRank() ? 1 : -1;
            }
        });
        for (Athlete vdv : a) {
